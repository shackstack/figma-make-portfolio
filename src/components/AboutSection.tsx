        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              2년차 프론트엔드 개발자로서 라텔앤드파트너즈에서 React와 TypeScript를 주력으로 
              다양한 프로젝트를 개발해왔습니다. WebView 환경에서의 네이티브-웹 통신, API 타입 자동화, 
              배포 파이프라인 구축 등 실무에서 직접 문제를 해결하며 성장해왔습니다.
            </p>
            <p className="text-gray-300 leading-relaxed">
              단순히 기능을 구현하는 것을 넘어, 개발 생산성을 높이고 유지보수가 쉬운 코드를 작성하는 것을 
              중요하게 생각합니다. OpenAPI를 활용한 타입 동기화 시스템 구축으로 PR 리드타임을 70% 단축하고, 
              sendBeacon API 최적화로 iOS 환경에서의 로깅 성공률을 100%로 개선한 경험이 있습니다.
            </p>
            ...
            >
              {['문제 해결', '타입 안정성', '성능 최적화', '협업 중시'].map((trait, index) => (
                <span
                  key={trait}
